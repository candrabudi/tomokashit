    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <h5>Data Banner</h5>
                <a class="btn btn-primary btn-sm" href="#" data-bs-toggle="modal" data-bs-target="#createModal">Tambah Banner</a>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered table-centered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge {{ $banner->status == 'aktif' ? 'bg-success' : 'bg-danger' }}">
                                        {{ ucfirst($banner->status) }}
                                    </span>
                                </td>
                                <td>
                                    <a href="#" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editModal{{ $banner->id }}">Edit</a>
                                    <form action="{{ route('system.banners.destroy', $banner->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                            ...
                            <div class="modal fade" id="editModal{{ $banner->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $banner->id }}" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('system.banners.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="url_redirect" name="url_redirect" value="{{ $banner->url_redirect }}">
                                                </div>
                                                <div class="mb-3">
