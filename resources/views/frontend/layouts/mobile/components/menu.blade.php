    ...
    <div class="relative z-1 rd-t-30 bg-paper" style="background: #191D26; padding: 5px;">
        ...
        <div class="flex items-center pb-20 pt-30">
            ...
            <div class="flex items-center flex-1 overflow-x-auto">
                <div
                    class="flex items-center overflow-x-auto whitespace-nowrap scrollbar-hide">
                    <button
                    ...
                    <button
                        ...
                        <div class="var-button__content">
                            <div class="flex items-center">
                                <img class="h-38 w-38"
                                    src="https://s.spotbets.cc/pub/game/zc5scx01h35d659vpt9o232oacoaheb1.png"
                                    alt="Tembak Ikan">
                                <div class="ml-10">Tembak Ikan</div>
                            </div>
                        </div>
                        <div class="var-hover-overlay"></div>
                    </button>
                    <button
                        ...
                        <div class="var-button__content">
                            <div class="flex items-center">
                                <img class="h-38 w-38"
                                    src="https://s.spotbets.cc/pub/game/zc5scx01h35d659wnh730srp98qjmct0.png"
                                    alt="Permainan virtual">
                                <div class="ml-10">Permainan virtual</div>
                            </div>
                        </div>
                        <div class="var-hover-overlay"></div>
                    </button>
                    <button
                        ...
                        <div class="var-button__content">
                            <div class="flex items-center">
                                <img class="h-38 w-38"
                                    src="https://s.spotbets.cc/pub/game/zc5scx01h35d659wrlt9judpcujnr619.png"
                                    alt="Lotre">
                                <div class="ml-10">Lotre</div>
                            </div>
                        </div>
                        <div class="var-hover-overlay"></div>
                    </button>
                    <button
                        ...
                        <div class="var-button__content">
                            <div class="flex items-center">
                                <img class="h-38 w-38"
                                    src="https://s.spotbets.cc/pub/game/zc5scx01h35d659wv9dhe3epfzn95d7h.png"
                                    alt="E-Sport">
                                <div class="ml-10">E-Sport</div>
                            </div>
                        </div>
                        <div class="var-hover-overlay"></div>
                    </button>
                    <button
                        ...
                        <div class="var-button__content">
                            <div class="flex items-center">
                                <img class="h-38 w-38"
                                    src="https://s.spotbets.cc/pub/game/zc5scx01h35d659wzc3fdigpj2tx8qzq.png"
                                    alt="Lainnya">
                                <div class="ml-10">Lainnya</div>
                            </div>
                        </div>
                        <div class="var-hover-overlay"></div>
                    </button>
