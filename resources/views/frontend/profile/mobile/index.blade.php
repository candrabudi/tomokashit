...
@section('content_mobile')
    <div id="app" class="scrollbar-hide" data-v-app="" style="background: #232A34">
        <div>
            <div class="mine relative overflow-y-auto bg-[var(--paper-background)] px-[20px] h-dvh mine-vip0" style="background: #232A34">
                ...
                <div class="mine-content relative pt-[40px]">
                    <div class="mb-[30px] flex justify-end pr-[20px]">
                        <div class="h-[50px] w-[50px]">
                            <div class="var-badge var--box relative">
                                ...
                                <span class="var-badge__content var-badge--danger absolute top-0 right-0 text-white bg-red-600 rounded-full h-[20px] w-[20px] text-center">
                                    <span>3</span>
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="w-full flex items-center" style="color: var(--color-text);">
                        <div class="relative mx-[20px]">
                            <div class="var-image var--box h-[150px] w-[150px] rounded-full overflow-hidden bg-gray-800">
                                <img role="img" class="var-image__image" src="https://m.7spb1772.com/assets/icon/avatar/avatar.png"
                    ...
                    <div class="flex justify-between mt-[20px]">
                        <div class="mine-share relative h-[140px] w-[344px] rounded-30px text-0 px-[30px] py-[22px]">
                            ...
                            <img src="https://m.7spb1772.com/assets/icon/mine/share.png" class="absolute bottom-0 right-0 h-[140px] w-[344px]">
                        </div>
                        <div class="mine-gift relative h-[140px] w-[344px] rounded-30px text-0 px-[30px] py-[22px]">
                            ...
                            <img src="https://m.7spb1772.com/assets/icon/mine/gift.png" class="absolute bottom-0 right-0 h-[140px] w-[344px]">
                        </div>
                    </div>
                    <div class="mx-20px mb-40px mt-50" style="margin-bottom: 128px">
                        <div class="h-[40px] text-[28px] color-text fw-500 leading-[40px] font-[font-title]" style="color: #FFFFFF;">Layanan
                            tambahan
                        </div>
